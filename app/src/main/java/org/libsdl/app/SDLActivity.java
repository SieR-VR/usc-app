    ...
    public void run() {
        if (!Environment.isExternalStorageManager()) {
            try {
                ...
                intent.setData(Uri.parse(String.format("package:%s", SDLActivity.mSingleton.getApplicationContext().getPackageName())));
                SDLActivity.mSingleton.startActivityForResult(intent, 1225);
            } catch (Exception e) {
